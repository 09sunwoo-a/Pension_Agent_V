...
- **부점 AI 01~04 구현:** 실제48명 데이터·공유 계약·remote transport·Python 검색/통계/추천/짧은 브리핑·명확화·멀티턴 상태·SSE를 연결했습니다. 숫자·ID·목록은 Python이 확정하고 LLM은 해석 후보/상담 문장에 사용합니다. 기존 JS 엔진은 명시적 local 데모/회귀 전용입니다.
