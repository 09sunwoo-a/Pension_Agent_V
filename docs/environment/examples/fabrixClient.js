 ...
 *   → docs/environment/09-보안-시크릿.md
 *
 * 용도:
 *   이 파일은 참고용이다. 화면에 로드되지 않는다.
 *   실제 연동 시 app/pensionAgentDemo.js 안으로 필요한 부분만 옮겨 쓴다.
 *   → docs/environment/06-출력계약-Contract.md §5 (연동 설계)
 *
 * 관련 문서:
 *   docs/environment/04-Fabrix-연계.md   — 규격 전체
 *   docs/environment/06-출력계약-Contract.md — 응답 어댑터
 */
...
(function (global) {
  ...
  //         // → 06-출력계약-Contract.md §5 normalizeAgentAnswer()
