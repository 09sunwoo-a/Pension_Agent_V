...
| 실행 가능한 검사 | `tests/branch-search/conversation.test.js`의 현재48명 로컬 엔진 검사. `tests/branch-search/golden/`의8명24턴은 별도 과거 회귀용 |
...
| 3 완료 | [03 데이터](03-DATA.md) | 같은48명 데이터 묶음·manifest·버전 및 제품 번들 일치 검증 PASS |
