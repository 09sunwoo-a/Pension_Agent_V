...
> **2026-09-21 모집단 변경:** 57명·기준일 2026-09-29 데이터로 36개 stub 골든의 기대값을 다시 산출했다(S-02 이하 연령 조건은 50대→40대: 현금성 장기대기 고객 중 50대가 없음). 아래 48명 기준 수치와 Google Gemma 108/108 결과는 이전 데이터 기록이며, Google 실측은 새 데이터로 다시 돌려야 한다.
