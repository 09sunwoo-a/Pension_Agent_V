...
def regressions():
    ...
    assert Q.value(d.by_id['lsm'], 'grade') == d.by_id['lsm']['customer']['starClubGrade']
    ...
    assert named['event']=='answer' and named['data']['result']['row_ids']==['lsm']
    ...
    assert follow['event']=='answer' and follow['data']['result']['row_ids']==['lsm']
