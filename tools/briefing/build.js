...
function artifacts(fileCode = DEFAULT_FILE_CODE) {
  ...
  const modules = ['briefing-contract.js', 'pensionCustomerView.js', 'pensionBriefingView.js',
    ...
    'branch-search-core.js', 'branch-search-current-data.js', 'branch-search-current-provider.js', 'branch-search-session.js',
    'branch-search-motion.js', 'branch-search-widget.js', 'branch-search-preserve-ui.js', 'branch-search-adapter.js', 'pensionAgentDemo.js'];
